...
&&  (echo "spack:" \
&&   echo "  specs:" \
&&   echo "  - picard@2.20.8 ^openjdk@11.0.2" \
...
RUN sed "s/'java'/'openjdk'/g" /opt/spack/var/spack/repos/builtin/packages/picard/package.py > /opt/spack/var/spack/repos/builtin/packages/picard/package.py.NEW && mv /opt/spack/var/spack/repos/builtin/packages/picard/package.py.NEW /opt/spack/var/spack/repos/builtin/packages/picard/package.py
